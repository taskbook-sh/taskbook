...
impl From<&ThemeColors> for TuiTheme {
    fn from(colors: &ThemeColors) -> Self {
        Self {
            ...
            success: Style::default().fg(Color::Rgb(colors.success.r, colors.success.g, colors.success.b)),
            warning: Style::default().fg(Color::Rgb(colors.warning.r, colors.warning.g, colors.warning.b)),
            ...
            pending: Style::default().fg(Color::Rgb(colors.pending.r, colors.pending.g, colors.pending.b)),
            starred: Style::default().fg(Color::Rgb(colors.starred.r, colors.starred.g, colors.starred.b)),
